        ...
        const createFace = (normal, uAxis, vAxis, offset) => {
            for (let i = 0; i < 2 ** subdivisions; i++) {
                for (let j = 0; j < 2 ** subdivisions; j++) {
                    ...
                    if (!reverse) {
                        self.addTriangle(p1.x, p1.y, p1.z, p3.x, p3.y, p3.z, p2.x, p2.y, p2.z);
                        self.addTriangle(p2.x, p2.y, p2.z, p3.x, p3.y, p3.z, p4.x, p4.y, p4.z);
                    } else {
                        self.addTriangle(p1.x, p1.y, p1.z, p2.x, p2.y, p2.z, p3.x, p3.y, p3.z);
                        self.addTriangle(p2.x, p2.y, p2.z, p4.x, p4.y, p4.z, p3.x, p3.y, p3.z);
                    }
                }
            }
        }
